...
public class MainFrame extends JFrame {
	...
	private void sendMessage() {
		try {
			...
			final String message = textAreaOutgoing.getText() + "           Время получения: " + time;
			...
			if (isValidInet4Address(destinationAddress) == false) {
				JOptionPane.showMessageDialog(this, "Введён неверный IPv4 адрес", "Ошибка", JOptionPane.ERROR_MESSAGE);
				textFieldTo.setText("");
				return;
			}
			if (message.isEmpty()) {
